...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Device.is_enabled'
        db.delete_column(u'devices_device', 'is_enabled')

        # Deleting field 'Dashboard.device'
        db.delete_column(u'devices_dashboard', 'device_id')


    def backwards(self, orm):
        # Adding field 'Device.is_enabled'
        db.add_column(u'devices_device', 'is_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Dashboard.device'
        db.add_column(u'devices_dashboard', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='dashboards', null=True, to=orm['devices.Device'], blank=True),
                      keep_default=False)
