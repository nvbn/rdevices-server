...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeviceMethod.description'
        db.alter_column(u'devices_devicemethod', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'DeviceMethod.description'
        db.alter_column(u'devices_devicemethod', 'description', self.gf('django.db.models.fields.TextField')(default=''))
