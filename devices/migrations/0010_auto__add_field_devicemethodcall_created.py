...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceMethodCall.created'
        db.add_column(u'devices_devicemethodcall', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceMethodCall.created'
        db.delete_column(u'devices_devicemethodcall', 'created')
