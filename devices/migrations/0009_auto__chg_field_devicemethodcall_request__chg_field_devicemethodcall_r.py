...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeviceMethodCall.request'
        db.alter_column(u'devices_devicemethodcall', 'request', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'DeviceMethodCall.response'
        db.alter_column(u'devices_devicemethodcall', 'response', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'DeviceMethodCall.request'
        db.alter_column(u'devices_devicemethodcall', 'request', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DeviceMethodCall.response'
        db.alter_column(u'devices_devicemethodcall', 'response', self.gf('django.db.models.fields.TextField')())
