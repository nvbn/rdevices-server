...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeviceMethod.spec'
        db.alter_column(u'devices_devicemethod', 'spec', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'DeviceMethod.spec'
        db.alter_column(u'devices_devicemethod', 'spec', self.gf('django.db.models.fields.TextField')())
