...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Device', fields ['uuid']
        db.create_index(u'devices_device', ['uuid'])

        # Adding index on 'DeviceMethod', fields ['name']
        db.create_index(u'devices_devicemethod', ['name'])


    def backwards(self, orm):
        # Removing index on 'DeviceMethod', fields ['name']
        db.delete_index(u'devices_devicemethod', ['name'])

        # Removing index on 'Device', fields ['uuid']
        db.delete_index(u'devices_device', ['uuid'])
