...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceMethodCall.method'
        db.add_column(u'devices_devicemethodcall', 'method',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['devices.DeviceMethod']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceMethodCall.method'
        db.delete_column(u'devices_devicemethodcall', 'method_id')
    ...
    models = {
        ...
        u'devices.devicemethodcall': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'method': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.DeviceMethod']"}),
