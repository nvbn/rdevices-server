...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dashboard.code'
        db.alter_column(u'devices_dashboard', 'code', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Dashboard.code'
        db.alter_column(u'devices_dashboard', 'code', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        u'devices.dashboard': {
            ...
            'device': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'dashboards'", 'null': 'True', 'to': u"orm['devices.Device']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
